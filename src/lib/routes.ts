...
const routes: Record<AppLocale, Record<RouteKey, string>> = {
  es: {
    ...
    probono_reglamento: "/es/probono-penal/reglamento",
  ...
  en: {
    home: "/en",
    about: "/en/about",
    "about.legalidad_diligencia": "/en/about/legalidad-diligencia",
    "about.independencia_tecnica": "/en/about/independencia-tecnica",
