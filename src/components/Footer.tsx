      ...
      <div className="container">
        <div className="footer-grid">
          ...
          <div className="footer-col">
            <h4 className="footer-title">{dict?.nav_title || 'Navegación'}</h4>
            <ul className="footer-links">
              <li><Link href={`/${locale}`}>{dict?.nav?.inicio || 'Inicio'}</Link></li>
              <li><Link href={`/${locale}/quienes-somos`}>{dict?.nav?.quienes_somos || 'Quiénes Somos'}</Link></li>
              <li><Link href={`/${locale}/nuestro-ceo`}>{dict?.nav?.nuestro_ceo || 'Nuestro CEO'}</Link></li>
          ...
          <div className="footer-col">
            <h4 className="footer-title">{dict?.services_title || 'Servicios'}</h4>
            <ul className="footer-links">
          ...
          <div className="footer-col">
            <h4 className="footer-title">{dict?.offices_title || 'Oficinas'}</h4>
            <ul className="footer-links">
              <li>{dict?.location || 'Torre Financiera, Caracas'}</li>
        ...
        <div className="footer-bottom">
          <div className="footer-copyright">
            <p>&copy; {new Date().getFullYear()} {dict?.copyright || 'Mac Consultores Jurídicos & Asociados. Todos los derechos reservados.'}</p>
