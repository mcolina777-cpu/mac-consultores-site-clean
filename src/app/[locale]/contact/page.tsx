        ...
        <div className="container">
          <div className="grid-2 contact-grid-start">
            <div className="contact-info">
              ...
              <h2 className="section-title mb-2rem">{dict?.contacto?.info?.title}</h2>
              ...
              <div className="contact-list contact-info-list mt-2rem">
                ...
                <div className="contact-item mb-0">
                  ...
                  <p className="mb-0"><a className="text-accent-bold" href="mailto:infomacconsul@gmail.com">infomacconsul@gmail.com</a></p>
                </div>
                <div className="contact-item mb-0">
                ...
                <form action="https://formsubmit.co/infomacconsul@gmail.com" method="POST">
                  ...
                  <div className="grid-2 form-grid-mobile mb-1rem gap-20px">
                    <div className="form-group">
                      <label className="form-label">{dict?.contacto?.form?.label_name}</label>
                      <input className="form-input" type="text" name="nombre" placeholder={dict?.contacto?.form?.placeholder_name} required  />
                    </div>
                    <div className="form-group">
                      <label className="form-label">{dict?.contacto?.form?.label_email}</label>
                      <input className="form-input" type="email" name="email" placeholder={dict?.contacto?.form?.placeholder_email} required  />
                    </div>
                  </div>

                  <div className="form-group mb-1rem">
                    <label className="form-label">{dict?.contacto?.form?.label_role}</label>
                    <input className="form-input" type="text" name="profesion" placeholder={dict?.contacto?.form?.placeholder_role} required  />
                  </div>

                  <div className="form-group mb-1-5rem">
                    <label className="form-label">{dict?.contacto?.form?.label_reason}</label>
                    <select className="form-input font-inherit" name="motivo" required defaultValue="">
                      <option value="" disabled >{dict?.contacto?.form?.reason_default}</option>
                      <option value="Defensa Penal Preventiva" >{dict?.contacto?.form?.reason_opt1}</option>
                      <option value="Proceso Penal en Curso" >{dict?.contacto?.form?.reason_opt2}</option>
                      <option value="Amparo Constitucional" >{dict?.contacto?.form?.reason_opt3}</option>
                      <option value="Asesoría Corporativa / Compliance" >{dict?.contacto?.form?.reason_opt4}</option>
                      <option value="Otros" >{dict?.contacto?.form?.reason_opt6}</option>
                    </select>
                  </div>

                  <div className="form-group mb-1-5rem">
                    <label className="form-label">{dict?.contacto?.form?.label_penal}</label>
                    <select className="form-input font-inherit" name="naturaleza-penal" defaultValue="No aplica">
                      <option value="No aplica" >{dict?.contacto?.form?.penal_default}</option>
                      <option value="Delitos Económicos / Financieros" >{dict?.contacto?.form?.penal_opt1}</option>
                      <option value="Delitos Informáticos" >{dict?.contacto?.form?.penal_opt2}</option>
                      <option value="Delitos Ordinarios" >{dict?.contacto?.form?.penal_opt3}</option>
                    </select>
                  </div>

                  <div className="form-group mb-1-5rem">
                    <label className="form-label">{dict?.contacto?.form?.label_desc}</label>
                    <textarea className="form-textarea" name="descripcion" rows={4} maxLength={500} placeholder={dict?.contacto?.form?.placeholder_desc} required></textarea>
                    <small className="form-hint form-hint-text">{dict?.contacto?.form?.hint_admin}</small>
                  </div>

                  <button type="submit" className="btn btn-primary w-100">{dict?.contacto?.form?.btn}</button>
                  
                  <p className="form-hint-center">{dict?.contacto?.form?.hint_relation}</p>
                </form>
              </div>
            </div>
          </div>
