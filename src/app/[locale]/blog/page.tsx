        ...
        <div className="container">
          <div className="grid-3">
            <article className="card">
              ...
              <p className="card-excerpt">{dict?.blog?.article1?.desc}</p>
            ...
            <article className="card">
              ...
              <p className="card-excerpt">{dict?.blog?.article2?.desc}</p>
            ...
            <article className="card">
              ...
              <p className="card-excerpt">{dict?.blog?.article4?.desc}</p>
