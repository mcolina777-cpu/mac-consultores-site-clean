        ...
        <div className="container" style={{ maxWidth: '840px', margin: '0 auto' }}>
          ...
          >
            <span className="section-tag">
              {isEs ? 'PRINCIPIO FUNDACIONAL 04' : 'FOUNDATIONAL PRINCIPLE 04'}
            </span>

            <h3 className="serif mt-1rem mb-1rem" style={{ fontSize: '1.4rem' }}>
              {isEs
                ? '“La confidencialidad protege la confianza necesaria para comprender, analizar y defender cada asunto con responsabilidad.”'
                : '“Confidentiality protects the trust required to understand, assess, and address every matter responsibly.”'}
            </h3>
            ...
            >
              {isEs
                ? 'Mac Consultores Jurídicos & Asociados trata la información confiada por sus clientes con reserva profesional, criterio jurídico y atención a los límites aplicables.'
                : 'Mac Consultores Jurídicos & Asociados handles information entrusted by its clients with professional discretion, legal judgment, and careful regard for applicable limits.'}
            </p>
