...
export default async function ServicesDelitosInformaticos({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return (
    <main className="page-delitos-informaticos">
        ...
        <div className="container">
          ...
          <div>
            <article className="mb-3rem">
              <h3 className="mb-1rem">{data?.areas?.cybercrimes?.title}</h3>
              <p>{data?.areas?.cybercrimes?.desc}</p>
            </article>

            <article className="mb-3rem">
              <h3 className="mb-1rem">{data?.areas?.fraud?.title}</h3>
              <p>{data?.areas?.fraud?.desc}</p>
            </article>

            <article className="mb-3rem">
              <h3 className="mb-1rem">{data?.areas?.evidence?.title}</h3>
              <p>{data?.areas?.evidence?.desc}</p>
            </article>

            <article className="mb-3rem">
              <h3 className="mb-1rem">{data?.areas?.integrity?.title}</h3>
              <p>{data?.areas?.integrity?.desc}</p>
            </article>

            <article className="mb-3rem">
              <h3 className="mb-1rem">{data?.areas?.privacy?.title}</h3>
              <p>{data?.areas?.privacy?.desc}</p>
            </article>
